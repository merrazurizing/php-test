...
-- Last modification date: 2021-06-25 13:59:35.883
...
CREATE TABLE candidato (
    ...
    fk_comuna_id int  NOT NULL,
    CONSTRAINT candidato_pk PRIMARY KEY (candidato_id)
);

-- Table: comuna
CREATE TABLE comuna (
    comuna_id serial  NOT NULL,
    comuna_nombre varchar(60)  NOT NULL,
...
CREATE TABLE formulario (
    formulario_id serial  NOT NULL,
    formulario_votante varchar(60)  NOT NULL,
    formulario_candidato varchar(60)  NOT NULL,
    recomendaciones varchar(200)  NOT NULL,
    CONSTRAINT formulario_pk PRIMARY KEY (formulario_id)
);
...
CREATE TABLE votante (
    ...
    fk_formulario_id int  NOT NULL,
    fk_candidato_id int  NOT NULL,
    CONSTRAINT votante_pk PRIMARY KEY (id)
);

-- foreign keys
-- Reference: Candidato_comunas (table: candidato)
ALTER TABLE candidato ADD CONSTRAINT Candidato_comunas
    FOREIGN KEY (fk_comuna_id)
    REFERENCES comuna (comuna_id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;

-- Reference: comunas_provincias (table: comuna)
ALTER TABLE comuna ADD CONSTRAINT comunas_provincias
...
-- Reference: provincias_regiones (table: provincia)
ALTER TABLE provincia ADD CONSTRAINT provincias_regiones
...
-- Reference: votante_candidato (table: votante)
ALTER TABLE votante ADD CONSTRAINT votante_candidato
    FOREIGN KEY (fk_candidato_id)
    REFERENCES candidato (candidato_id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;

-- Reference: votante_formulario (table: votante)
ALTER TABLE votante ADD CONSTRAINT votante_formulario
    FOREIGN KEY (fk_formulario_id)
    REFERENCES formulario (formulario_id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
...
-- End of file.
INSERT INTO region (region_id,region_nombre,region_ordinal)
VALUES
    ...
    INSERT INTO provincia (provincia_id,provincia_nombre,fk_region_id)
VALUES
    (1,'Arica',1),
    (2,'Parinacota',1),
    (3,'Iquique',2),
    ...
    INSERT INTO comuna (comuna_id,comuna_nombre,fk_provincia_id)
VALUES
    (1,'Arica',1),
    (2,'Camarones',1),
    (3,'General Lagos',2),
